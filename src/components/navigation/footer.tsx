    ...
    return (
        <footer className="" aria-labelledby="footer-heading">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="border-t border-gray-200 dark:border-dark-second p-2 md:flex md:items-center md:justify-between">
                    ...
                    <small className="mt-8 text-stone-200 dark:text-stone-200 md:mt-0 md:order-1 break-all break-words">
